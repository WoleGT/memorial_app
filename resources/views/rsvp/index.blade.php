  ...
  <nav class="navbar navbar-expand-lg">
    <div class="container"> 
      ...
      <ul class="navbar-nav ms-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="{{asset('booking8.html')}}"><i class="fas fa-chair"></i> Book a Table</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="{{ asset('rsvp.html')}}"><i class="fas fa-location"></i> Get Direction</a>
        </li>
      </ul>
    </div>
  </nav>
