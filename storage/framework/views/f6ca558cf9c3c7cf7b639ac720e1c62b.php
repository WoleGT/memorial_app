...
<h3>Survived by:</h3>
    ...
    <ul style="padding-left:40px">
        <li>  
           <a href="<?php echo e(asset('Wake-Keep program.pdf')); ?>"  target="_blank" style="text-decoration:none" id="a1">Wake-keep Program</a>
        </li>
        <li>
           <a href="<?php echo e(asset('burial program online.pdf')); ?>" target="_blank" style="text-decoration:none" id="a1">Order of Funeral Service</a>
        </li>
        <li>
